...
import { checkCandidatureId, createCandidature, deleteCandidature, editCandidature, getAllCandidaturesForJob, getAllCandidaturesForUser, getCandidatureById } from "../services/candidatures";
...
candidaturesRouter.post(
	...
	async (req:MyRequest, res) => {
		try {
			...
			const newCandidature = await createCandidature(user,jobId, fields,cv);
